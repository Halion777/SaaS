          ...
          <div className="border-b border-border mb-6">
            <nav className="-mb-px flex space-x-8">
              ...
              <button
                ...
                className={`py-2 px-1 border-b-2 font-medium text-sm ${activeTab === 'spam-reports'
                    ? 'border-blue-500 text-blue-600'
                    : 'border-transparent text-muted-foreground hover:text-foreground hover:border-gray-300'
                  }`}
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex bg-muted rounded-lg p-1">
                    <button
                      ...
                      className={`px-3 py-1 rounded-md text-xs font-medium transition-colors flex items-center ${viewMode === 'table'
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-md text-xs font-medium transition-colors flex items-center ${viewMode === 'card'
                          ? 'bg-background text-foreground shadow-sm'
                          : 'text-muted-foreground hover:text-foreground'
                        }`}
                    >
            ...
            <tbody>
              {spamReports.map((report) => (
                <tr key={report.id} className="border-t border-border hover:bg-muted/25">
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${report.review_status === 'pending' ? 'bg-yellow-100 text-yellow-800' :
          ...
          <div className="mt-6 pt-6 border-t border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="text-foreground">
                  <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${selectedLead.is_public ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                    }`}>
